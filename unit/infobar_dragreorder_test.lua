-- Verifies the pure helpers of modules/infobar/dragreorder.lua:
...
assert(loadfile(ROOT .. "modules/infobar/contextmenu.lua"))("QUI_InfoBar", ns)
assert(loadfile(ROOT .. "modules/infobar/dragreorder.lua"))("QUI_InfoBar", ns)

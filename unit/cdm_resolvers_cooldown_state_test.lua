...
ns.CDMSources.QueryScannedItemAuraInfo = function()
    error("cooldown resolution must not query scanner aura activity")
end
ns.CDMSpellData.GetCapturedAuraForLookup = function()
    error("cooldown resolution must not query captured aura activity")
end

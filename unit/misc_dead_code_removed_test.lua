...
--   * modules/utility/keybinds.lua ForceRebuildButtonCache — zero callers anywhere
--   * modules/minimap/minimap.lua ApplyMinimapButtonBackground — zero callers anywhere
...
local keybinds = readAll("modules/utility/keybinds.lua")
